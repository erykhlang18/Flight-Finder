...
public class Frontend implements FrontendInterface {
    ...
    public void getRoute() {
        ...
        PathInterface route = backend.getShortestRoute(start, end);
        if (route != null) {
            displayRoute(route);
        } else {
     ...
     */
    private void displayRoute(PathInterface route) {
        List<String> airports = route.getRoute();
        List<Double> miles = route.getMilesSegment();
        Double totalMiles = route.getTotalMiles();
