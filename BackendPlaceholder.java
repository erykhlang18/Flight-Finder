...
public class BackendPlaceholder implements BackendInterface {
    ...
    @Override
    public PathInterface getShortestRoute(String start, String end) {
     ...
     */
    private static class ShortestPathPlaceholder implements PathInterface {
        ...
        public List<Double> getMilesSegment() {
            ...
            return Arrays.asList(100.0, 200.0);
        }
